            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="info-box card">
                  ...
                  <h3>Address</h3>
                  <p>A108 Adam Street,<br />Accra, ACC-071-0088</p>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="info-box card">
                  ...
                  <h3>Call Us</h3>
                  <p>+233 550 876 555<br />+233 550 876 555</p>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="info-box card">
                  <i class="bi bi-envelope"></i>
                  <h3>Email Us</h3>
                  <p>nanayaw@mail.com<br />swiftcarrentals@mail.com</p>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="info-box card">
